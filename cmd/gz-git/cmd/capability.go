...
const (
	...
	contextReferenceObserveV1Capability   = "context-reference-observe-v1"
)
...
func supportsCapability(name string) bool {
	switch name {
	case integrateReadinessV1Capability, integrateQueueControllerV1Capability, integrateQueueBaseMissingV1Capability, contextReferenceObserveV1Capability:
		return true
	default:
		return false
	}
