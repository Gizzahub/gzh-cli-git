...
func TestCommitAutoCommand(t *testing.T) {
	...
	t.Run("no staged changes", func(t *testing.T) {
		...
		if !strings.Contains(output, "no changes") && !strings.Contains(output, "nothing to commit") {
	...
	t.Run("dry run mode", func(t *testing.T) {
		...
		AssertContains(t, output, "Generated commit message")
		AssertNotContains(t, output, "Created commit")
	})
}
...
func TestCommitValidateCommand(t *testing.T) {
	...
	t.Run("subject too long", func(t *testing.T) {
		...
		AssertContains(t, output, "length")
	})
...
func TestCommitTemplateCommands(t *testing.T) {
	...
	t.Run("list templates", func(t *testing.T) {
		...
		AssertContains(t, output, "simple")
	})
	...
	t.Run("show simple template", func(t *testing.T) {
		output := repo.RunGzhGitSuccess("commit", "template", "show", "simple")
